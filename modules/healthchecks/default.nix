...
#
# - Supports dead man healthchecks
#   Enabling the module, enables a base server is alive check
# - Adding the following to other modules, enables individual checks
#   modules.healthchecks.systemd-monitoring.${systemdServiceName}.checkUrlFile = <url>
# IMPORTANT: the check url's should be secrets to avoid other's from pinging
